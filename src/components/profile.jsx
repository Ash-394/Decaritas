...
function Profile() {
    ...
    const showOrgComponent = () => {
        setShowOrg(prevState => !prevState);
    }
    ...
    return (
        <div className="h-screen relative ">
            <div className="absolute inset-0 flex flex-col items-center">
                ...
                <button className='me-2 mb-2' onClick={showOrgComponent}>Organization</button>
                <button className='me-2 mb-2' onClick={showUserComponent}>User</button>
                </div>
                
                {showOrg && <OrganizationPage contract={contract}/>}
