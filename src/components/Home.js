...
const Home = () => {
    return (
      ...
      "url('https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?q=80&w=1912&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
        ...
        <h1 className="text-black text-6xl font-bold mb-4 ">de-Caritas</h1>
        <p className="text-black text-2xl font-sans">A blockchain based donation traceability framework</p>
      </div>
      </div>
    );
  };
