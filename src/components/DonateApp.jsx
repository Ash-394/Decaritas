...
const FundingApp = () => {
  ...
  const initializeContract = async () => {
    ...
    const contractAddress = "0xF1E5C4CB33dD951d202F27405E3471cCAe837052"; // Replace with your contract address
  ...
  return (
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-slate-700 via-slate-900 to-slate-900"></div>
    
    <div className="absolute inset-0 flex justify-center items-center">
      <img
        className="max-h-full max-w-full"
        style={{ marginBottom: "-100px" }}
        src="https://www.wordstormpr.com.au/wp-content/uploads/2014/07/charity.png"
        alt="Charity"
      />
    </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center">
       <button
          type="button"
          class="text-gray-900 bg-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800  border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2"
